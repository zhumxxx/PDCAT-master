...
if __name__ == '__main__':
    ...
    cfsca_params['include_path'] = '-I /data/mingxuanzhu/PDCAT-master/Benchmarks/polyBench/utilities /data/mingxuanzhu/PDCAT-master/Benchmarks/polyBench/utilities/polybench.c'
